...
namespace CrossOverApplication.Data.Extensions
{
    public static class IdentityExtensions
    {
        ...
        {
            return externalLoginInfo == null ? null : new ApplicationExternalLoginInfo { DisplayName = externalLoginInfo.ProviderDisplayName, Principal = externalLoginInfo.Principal, AuthenticationTokens = externalLoginInfo.AuthenticationTokens, LoginProvider = externalLoginInfo.LoginProvider, ProviderKey = externalLoginInfo.ProviderKey };
        }

        public static ExternalLoginInfo ToExternalLoginInfo(this ApplicationExternalLoginInfo externalLoginInfo)
        {
            return externalLoginInfo == null ? null : new ExternalLoginInfo(externalLoginInfo.Principal, externalLoginInfo.LoginProvider, externalLoginInfo.ProviderKey, externalLoginInfo.DisplayName);
        }
        ...
        public static ApplicationAuthenticationDescription ToApplicationAuthenticationDescription(this AuthenticationDescription authenticationDescription)
        {
            ...
            var description = new ApplicationAuthenticationDescription { AuthenticationScheme = authenticationDescription.AuthenticationScheme, DisplayName = authenticationDescription.DisplayName };
            description.Properties.Clear();
            foreach (var property in authenticationDescription.Items)
            {
        ...
        public static AuthenticationDescription ToAuthenticationDescription(this ApplicationAuthenticationDescription authenticationDescription)
        {
            ...
            var description = new AuthenticationDescription { AuthenticationScheme = authenticationDescription.AuthenticationScheme, DisplayName = authenticationDescription.DisplayName };
            description.Items.Clear();
            foreach (var property in authenticationDescription.Properties)
            {
                description.Items.Add(property.Key, property.Value);
            }
            return description;
        }
        ...
        {
            return loginInfo == null ? null : new UserLoginInfo(loginInfo.LoginProvider, loginInfo.ProviderKey, loginInfo.DisplayName);
        }
